...
public class PackageRegistryStepdefsTest extends AbstractPackageRegistryTest {
    ...
    public void background(String supplier, String supplier2, String trackingId, String trackingId2) throws Exception{
        packagesToDelete = new HashSet<>();
        suppliersToDelete = new HashSet<>();
        suppliersToDelete.add(supplierRegistration.register(supplier, "0649712258"));
        suppliersToDelete.add(supplierRegistration.register(supplier2, "0649712255"));
        ...
        packagesToDelete.add(management.register(trackingId, supplierObject.get(), 5.0f, "Nice ville"));
        packagesToDelete.add(management.register(trackingId2, supplierObject.get(), 8.0f, "Nice ville"));
    }
    ...
    public void deletePackage(String trackingId) throws Exception{
        ...
        packagesToDelete.removeIf(e -> e.getTrackingNumber().equals(trackingId));
    }
    ...
    public void deletePackages(String trackingId, String trackingId2) throws Exception{
        ...
        packagesToDelete.removeIf(e -> e.getTrackingNumber().equals(trackingId));
        packagesToDelete.removeIf(e -> e.getTrackingNumber().equals(trackingId2));
    }
    ...
    @Then("^the package with trackingId (.*) does not exist anymore$")
    public void checkDeletePackage(String trackingId){
