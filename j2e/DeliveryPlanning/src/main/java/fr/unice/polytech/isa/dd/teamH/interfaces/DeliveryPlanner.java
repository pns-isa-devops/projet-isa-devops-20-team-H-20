...
public interface DeliveryPlanner {
    ...
    boolean deletePlanningEntry(String trackingNumber) throws UnknownPlanningEntryException;
    boolean deletePlanningEntry(int droneId) throws UnknownPlanningEntryException;
}
