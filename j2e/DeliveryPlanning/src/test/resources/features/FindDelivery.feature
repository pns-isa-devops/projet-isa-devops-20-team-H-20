Feature: Plan delivery
  ...
  Scenario: There are 2 deliveries in the system and 1 find delivery #2
    When the service client searches the delivery with UIDL45B as package
    Then the delivery is found

  Scenario: There are 2 deliveries in the system and 1 find planing #1
    When the service client searches the planning entry for delivery with UIDL45B as package
