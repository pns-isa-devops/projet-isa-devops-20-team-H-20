Feature: Generate drone stats
  ...
  Background:
    Given some delivery with date 2020-05-20 time 08:30 and with UIDL0 as package with supp1 as Supplier
    And some delivery with date 2020-05-20 time 08:30 and with UIDL1 as package with supp2 as Supplier
