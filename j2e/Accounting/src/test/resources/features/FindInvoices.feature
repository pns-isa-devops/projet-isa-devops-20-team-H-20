Feature: Find invoices
  ...
  Background:
    Given some deliveries with UIDL45A and UIDL45W as package with LePosta as supplier and UIDL45C as package with Nozama as supplier and 1 as drone and all deliveries are completed
